...
document.addEventListener("DOMContentLoaded", function() {
  // Добавление класса к кнопкам Previous и Next
  let prevButton = document.querySelector('[data-fancybox]').querySelector('.f-button.is-prev');
  let nextButton = document.querySelector('[data-fancybox]').querySelector('.f-button.is-next');
